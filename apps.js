...
var showAnswerers = function(topAnswerers){

	var result = $ ('.templates .topAnswerers').clone();
	console.log(result);
	
	var Answerer = result.find('.Answerer');
	Answerer.text(topAnswerers.user.display_name);
...
var getInspiration = function(searchTerm) {

	var request = {tag: searchTerm,
						site: 'stackoverflow',
					}			
	var result = $.ajax({ 
		url:"http://api.stackexchange.com/2.2/tags/" + searchTerm + "/top-answerers/month",
		data: request,
		dataType: "jsonp",
		type: "GET",
